...
| 5 | [界面预览](#界面预览) | 登录、知识问答、知识库管理、管理后台页面截图 |
| 6 | [快速开始](#快速开始) | Docker Compose 部署与本地开发环境指引 |
| 7 | [项目结构](#项目结构) | 后端分层、RAG 核心模块、前端结构、测试金字塔目录树 |
| 8 | [质量保障](#质量保障) | 检索召回、答案评分、回归通过率、多轮保活性指标 |
| 9 | [设计文档](#设计文档) | PRD / 架构 / 数据库 / API / RAG / 前端 / UI / ADR 文档索引 |
| 10 | [常见问题](#常见问题) | 文档格式、LLM、检索协同、上下文管理、置信度评估问答 |
